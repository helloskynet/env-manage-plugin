...
<p align="center">
  <a href="https://www.npmjs.com/package/env-plugin">
    <img src="https://img.shields.io/npm/v/env-plugin.svg" alt="npm 版本">
  </a>
  <a href="https://www.npmjs.com/package/env-plugin">
    <img src="https://img.shields.io/npm/dw/env-plugin.svg" alt="npm 下载量">
  </a>
  <a href="https://nodejs.org">
    <img src="https://img.shields.io/node/v/env-plugin.svg" alt="Node 版本">
  </a>
  <a href="LICENSE">
    <img src="https://img.shields.io/github/license/lumos934/env-plugin" alt="许可证">
  </a>
</p>
...
```bash
# 使用 npm
npm install env-plugin --save-dev

# 或使用 pnpm (推荐)
pnpm add env-plugin -D

# 或使用 yarn
yarn add env-plugin -D
```
...
```javascript
// webpack.config.js
const { envmWebpackPlugin } = require("env-plugin");
...
```typescript
// rollup.config.js
import { envmRollupPlugin } from "env-plugin";
...
```typescript
// rspack.config.js
import { envmRspackPlugin } from "env-plugin";
...
- 🐛 [问题反馈](https://github.com/lumos934/env-plugin/issues)
- 💬 [讨论交流](https://github.com/lumos934/env-plugin/discussions)
